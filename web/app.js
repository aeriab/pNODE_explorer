...
const S = {
  ...
  observedComposition:[], compTaxa:null, showObserved:false,
...
async function init(){
  ...
  $('obsToggle').addEventListener('change', e=>{
    ...
    $('compTitle').textContent = S.showObserved
      ? 'Observed microbiome composition (16S samples)' : 'Predicted microbiome composition';
